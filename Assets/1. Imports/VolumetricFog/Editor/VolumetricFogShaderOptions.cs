    ...
    public class VolumetricFogShaderOptions {
        ...
        public void ReadOptions() {
            ...
            options = new ShaderAdvancedOption[]
            {
                ...
                new ShaderAdvancedOption
                {
                    id = "FOG_AREA_NOISE_USES_WORLD_SPACE",
                    name = "World Space Noise in Fog Areas",
                    description = "Uses world space instead of local space when rendering noise inside fog areas."
                },
                new ShaderAdvancedOption
                {
