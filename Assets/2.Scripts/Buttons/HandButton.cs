...
public class HandButton : XRBaseInteractable
{
    ...
    {
        // Call base functionality in XRBaseInteractable
        base.Awake();
    ...
    private void SetMinMax()
    {
        ...
        yMin = transform.localPosition.y - (collider.bounds.size.y * 0.7f);
    ...
    // Check whether we can invoke on press
    private bool InPosition()
    {
        float inRange = Mathf.Clamp(transform.localPosition.y, yMin, yMin + 0.01f);

        // If not clamped, then within range
